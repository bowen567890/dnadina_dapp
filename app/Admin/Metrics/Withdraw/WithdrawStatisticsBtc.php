...
class WithdrawStatisticsBtc extends Card
{
    ...
    public function handle( $request)
    {
        ...
        switch ($request->get('option')) {
            default:
                ...
                $c_withdraw = $cWebsiteAnalyzeDaily->withdraw_btc;
                $c_withdraw_issue = $yWebsiteAnalyzeDaily->withdraw_btc_issue;
                
                $y_withdraw = $yWebsiteAnalyzeDaily->withdraw_btc;
                $y_withdraw_issue = $yWebsiteAnalyzeDaily->withdraw_btc_issue;
                
                $WebsiteStatistic = WebsiteStatistic::query()->where('id', 1)->first();
                $withdraw = $WebsiteStatistic->withdraw_btc;
                $withdraw_issue = $WebsiteStatistic->withdraw_btc_issue;
