        ...
        return Form::make(new MainCurrency(), function (Form $form) {
            ...
            $form->saving(function (Form $form) {
                ...
                if ($post && isset($post['contract_address']))
                {
                    ...
                    if ($id==1) {
                        $form->contract_address = config('env.USDT_ADDRESS');
                        $form->price = '1';
                        $form->is_sync = 0;
                    ...
                    if ($id==2) {
                        $form->contract_address = config('env.WNADI_ADDRESS');
                        $form->contract_address_lp = config('env.WNADI_ADDRESS_LP');
                        $form->is_sync = 0;
                    }
                    
                    if ($id==3) {
                        $form->contract_address = config('env.DHT_ADDRESS');
                        $form->contract_address_lp = config('env.DHT_ADDRESS_LP');
                        $form->is_sync = 0;
                    }
