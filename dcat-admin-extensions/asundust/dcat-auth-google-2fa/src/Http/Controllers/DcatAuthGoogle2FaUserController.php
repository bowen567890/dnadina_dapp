...
use App\Admin\Actions\HiddenContextMenuActions;
...
class DcatAuthGoogle2FaUserController extends UserController
{
    protected function grid()
    {
        return Grid::make(Administrator::with(['roles']), function (Grid $grid) {
            ...
            $grid->setActionClass(HiddenContextMenuActions::class);
            $grid->actions(function (HiddenContextMenuActions $actions) {
